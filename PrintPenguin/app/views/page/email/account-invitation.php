        ...
        <div class="row my-5 g-0">
            <div class="col-6 d-none d-lg-block bg-primary rounded-6">
                <div class="p-40 text-white h-100 d-flex flex-column justify-content-between">
                    ...
                    <a href="#" class="p-40 btn-link bg-white-opacity rounded-6 d-flex align-items-center justify-content-between text-white btn-animation-arrow">
            ...
            <div class="col-12 col-lg-6">
               ...
               <div class="p-sm-50 p-50 my-xl-5">
                    <form id="formSignIn">
                        ...
                        <div class="row">
                            <div class="col-12 mb-4">
                                ...
                                <input type="email" class="form-control text-xxs" name="E-Mail_Address" id="formSignInMail" placeholder="johnsmith@gmail.com">
                            </div>
                            <div class="col-12 mb-4">
                                <label for="formSignInPassword" class="form-label">Password</label>
                                <input type="password" class="form-control text-xxs" name="Password" id="formSignInPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
                            </div>
                        </div>
                        <button type="button" class="btn btn-primary w-100" data-bs-target="#acceptInvitationModal" data-bs-toggle="modal">Sign In</button>
                    </form>
                    <p class="text-center my-4">Or</p>
                    <button type="button" class="btn btn-white-with-border d-flex justify-content-center w-100 align-items-center mb-3 mb-xl-0">Create a free account</button>
...
<!-- ACCEPT INVITATION -->
<div class="modal fade" id="acceptInvitationModal" aria-hidden="true" aria-labelledby="acceptInvitationModalLabel" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content p-4 rounded-6">
      ...
      <div class="modal-body p-xl-40 py-4">
          <h3 class="mb-4 text-center" id="acceptInvitationModalLabel">Do you want to accept invitation?</h3>
          <p class="text-center">Are you sure you want to cancel product customization and back to main page?</p>
          <div class="text-center mt-5">
              <button type="button" class="btn btn-red text-white mb-3 mb-sm-0 me-sm-3" data-bs-dismiss="modal" aria-label="Close">No, Cancel</button>
              <button type="button" class="btn btn-green text-white mb-3 mb-sm-0" data-bs-dismiss="modal">Yes, I want</button>
          </div>
      </div>
    </div>
  </div>
